...
public class ShowMore_LV_Activity extends Activity {
    ...
    private void getListInfo() {
        ...
        final int position = intent.getIntExtra("more_lv_position", 0);
        // type=2&key=0&top=1&
        params.addBodyParameter("type", "2");
        params.addBodyParameter("key", "0");
        params.addBodyParameter("top", "1");
        HttpUtils utils = new HttpUtils();
        utils.send(HttpRequest.HttpMethod.POST, Kind_Url.MoreStr.get(position), params, new RequestCallBack<String>() {
            @Override
...
//                Log.v("--DEBUG--", "-->  " + url);
                ...
                BitmapUtils bmutils = new BitmapUtils(ShowMore_LV_Activity.this);
